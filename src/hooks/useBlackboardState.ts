      ...
      switch (command.type) {
        ...
        case 'draw_table': {
          ...
          const tableElement: Omit<TableElement, 'id' | 'createdAt'> = {
            ...
            color: tableParams.color || '#FAFAF7',
            visible: true,
            opacity: 1,
            zIndex: Date.now(),
          };
